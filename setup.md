...
available at `crafty.<public-domain>` and `crafty.<public-domain>.local`; both
use Crafty's normal native administrator login with no MFA by default. The
Bedrock game endpoint
