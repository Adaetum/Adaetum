...

{
  ...
  emit_env_line TAILSCALE_OPERATOR_OAUTH_CLIENT_ID "${TAILSCALE_OPERATOR_OAUTH_CLIENT_ID:-}"
  emit_env_line TAILSCALE_OPERATOR_OAUTH_CLIENT_SECRET "${TAILSCALE_OPERATOR_OAUTH_CLIENT_SECRET:-}"
