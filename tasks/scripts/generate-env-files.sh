...
[ -n "${default_ingress_public_hosts}" ] || default_ingress_public_hosts="$(printf '%s' "registry.${CLUSTER_DOMAIN},gitea.${CLUSTER_DOMAIN},argocd.${CLUSTER_DOMAIN},authentik.${CLUSTER_DOMAIN},headlamp.${CLUSTER_DOMAIN},home.${CLUSTER_DOMAIN},alertmanager.${CLUSTER_DOMAIN},grafana.${CLUSTER_DOMAIN},ntfy.${CLUSTER_DOMAIN},prometheus.${CLUSTER_DOMAIN}")"
CLOUDFLARED_INGRESS_PUBLIC_HOSTS="${default_ingress_public_hosts}"
default_ingress_cleanup_hosts="$(printf '%s' "registry.${CLUSTER_DOMAIN},gitea.${CLUSTER_DOMAIN},argocd.${CLUSTER_DOMAIN},authentik.${CLUSTER_DOMAIN},headlamp.${CLUSTER_DOMAIN},home.${CLUSTER_DOMAIN},alertmanager.${CLUSTER_DOMAIN},grafana.${CLUSTER_DOMAIN},ntfy.${CLUSTER_DOMAIN},prometheus.${CLUSTER_DOMAIN}")"
