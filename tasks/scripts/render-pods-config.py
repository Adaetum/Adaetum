...
TEMPLATE_TARGETS = [
    ...
    ("pods/ingress/nginx-routing/crafty-ingress.yaml.tmpl", "pods/ingress/nginx-routing/crafty-ingress.yaml"),
    ("pods/ingress/nginx-routing/crafty-public-ingress.yaml.tmpl", "pods/ingress/nginx-routing/crafty-public-ingress.yaml"),
    ...
    ("pods/ingress/observability-routing/ntfy-ingress.yaml.tmpl", "pods/ingress/observability-routing/ntfy-ingress.yaml"),
    ("pods/ingress/observability-routing/ntfy-public-ingress.yaml.tmpl", "pods/ingress/observability-routing/ntfy-public-ingress.yaml"),
...
def render_templates(config: dict[str, str], check: bool) -> list[str]:
    ...
    literal_replacements = {
        ...
        "ntfy.example.local": config["NTFY_LOCAL_HOST"],
        "ntfy.example.services": config["NTFY_PUBLIC_HOST"],
        ...
        "crafty.example.local": config["CRAFTY_LOCAL_HOST"],
        "crafty.example.services": config["CRAFTY_PUBLIC_HOST"],
