...
OPENBAO_TRANSIT_SEAL_ADDRESS=$(existing_env_value .env OPENBAO_TRANSIT_SEAL_ADDRESS)
OPENBAO_TRANSIT_SEAL_TOKEN=$(existing_env_value .env OPENBAO_TRANSIT_SEAL_TOKEN)
OPENBAO_TRANSIT_SEAL_KEY_NAME=$(existing_env_value .env OPENBAO_TRANSIT_SEAL_KEY_NAME)
OPENBAO_TRANSIT_SEAL_MOUNT_PATH=$(existing_env_value .env OPENBAO_TRANSIT_SEAL_MOUNT_PATH)
OPENBAO_TRANSIT_SEAL_NAMESPACE=$(existing_env_value .env OPENBAO_TRANSIT_SEAL_NAMESPACE)
OPENBAO_TRANSIT_SEAL_TLS_SERVER_NAME=$(existing_env_value .env OPENBAO_TRANSIT_SEAL_TLS_SERVER_NAME)
OPENBAO_TRANSIT_SEAL_CA_CERT_B64=$(existing_env_value .env OPENBAO_TRANSIT_SEAL_CA_CERT_B64)
